...
ENTRYPOINT ["/usr/bin/java", "-agentpath:/usr/local/YourKit-JavaProfiler-2018.04/bin/linux-x86-64/libyjpagent.so=port=10001,listen=all","-jar", "-Dlog4j.configurationFile=log4j2-file.xml", "/opt/scalecube/app.jar"]
