...
CMD exec java $DEFAULT_JAVA_OPTS $JAVA_OPTS $DEFAULT_JMX_OPTS $DEFAULT_OOM_OPTS $YOURKIT_AGENT -Dlog4j.configurationFile=log4j2-benchmarks.xml -cp benchmarks.jar $PROGRAM_ARGS
