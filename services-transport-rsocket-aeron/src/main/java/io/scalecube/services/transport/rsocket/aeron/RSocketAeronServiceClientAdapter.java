...
public class RSocketAeronServiceClientAdapter implements ClientChannel {

  private Mono<RSocket> rsocket;
  private ServiceMessageCodec messageCodec;

  public RSocketAeronServiceClientAdapter(Mono<RSocket> rsocket, ServiceMessageCodec codec) {
