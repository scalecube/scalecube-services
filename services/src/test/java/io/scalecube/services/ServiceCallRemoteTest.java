...
public class ServiceCallRemoteTest extends BaseTest {
  ...
  @Test
  public void test_remote_async_greetings_return_GreetingResponses() {
    Type type = new TypeReference<List<GreetingResponse>>() {}.getType();

    // When
    Publisher<ServiceMessage> result = gateway.call().requestOne(LIST_GREETING_REQUESTS_REQ, type);
