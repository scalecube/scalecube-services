...
public class RequestResponseInvokerTest extends BaseTest {
  ...
  public void test_invoker_registry() throws InterruptedException {
    ...
    registry.register("sayHello", new RequestResponseInvoker(service, method, new DummyStringCodec()));

    Publisher<ServiceMessage> resp = registry.requestResponse(ServiceMessage.builder().qualifier("sayHello").data("ronen").build());   
