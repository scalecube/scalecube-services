...
public interface ClientTransport {
  ...
  /**
   * Initiate cleaning of underlaying resources (if any) like closing websocket connection or rSocket session.
   * Subsequent calls of requestOne() or requestMany() must issue new connection creation. Note that close is not the
   * end of client lifecycle.
   *
