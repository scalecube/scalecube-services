...
public interface Transport {
  ...
  /**
   * Sends message to the given transportChannel. It will issue connect in case if no transport channel by given
   * {@code address} exists already. Send is an async operation, if result of operation is not needed use
   * {@link Transport#send(Address, Message)}, otherwise pass {@link CompletableFuture}.
   *
